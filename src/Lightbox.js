...
class Lightbox extends React.Component {
  ...
  clickNext() {
    ...
    const index =
      selectedImage === undefined || selectedImage + 1 >= max
        ? max
        : selectedImage + 1;
    handleChangeSelectedImage(index);
  }
    ...
    return (
      <div>
        ...
        <div
          ...
          tabIndex="0"
        >
          <div id="close" onClick={this.clickClose}>
            X
          </div>
          <div id="controlsContainer">
            <div id="prev" onClick={this.clickPrev}>
              &lt;&lt;
            </div>
            ...
            <div id="next" onClick={this.clickNext}>
              &gt;&gt;
            </div>
          </div>
        </div>
...
Lightbox.propTypes = {
  ...
  handleChangeSelectedImage: PropTypes.func,
};
